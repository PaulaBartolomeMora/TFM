...
Teniendo todo el procedimiento anterior en cuenta, se puede expresar que, a partir de una serie de características, el objetivo es escoger aquellas que contribuyan a obtener una mayor precisión en la clasificación de datos de entrada futuros. Mediante el entrenamiento progresivo de la \gls{ann}, se podrán seleccionar las más importantes y establecer las conexiones óptimas entre los nodos de las capas ocultas. Es preciso indicar que el funcionamiento del modelo se basa en una red de propagación hacia delante, lo que supone que se defina un flujo unidireccional, desde la entrada a la salida. No obstante, para ajustar las ponderaciones se aporta una retroalimentación, que depende directamente de la función de coste y de la salida del modelo en cada ejecución o \textit{epoch}. Generalmente, se aplica el método del gradiente descendiente para encontrar la configuración de pesos que minimice la función de coste. \cite{ibmann}

...
En cuanto a los resultados de aplicación del método \textit{K-Fold Cross Validation}, se puede que comprobar en la Tabla \ref{tab:svmk} que se obtienen valores de precisión parecidos a los dados anteriormente. En este caso, con escasas diferencias, se presenta como mejor opción la aplicación de la técnica \textit{kbest} con 8 características con un ---\%.
...
\begin{table}[H]
  ...
  \cellcolor[HTML]{EFEFEF}\textit{kbest (n=8)} &  &  \\ \hline

...
En otros términos, la identificación de patrones se apoyará en el análisis de grandes volúmenes de datos provenientes de implementaciones de \gls{sg}s reales. Estos serán previamente procesados de una forma exhaustiva para reducir su tamaño y seleccionar la información verdaderamente necesaria para el posterior desarrollo de los modelos. En la Figura \ref{fig:intro} se determina el diagrama de flujo que define la secuencia de acciones a realizar. Es preciso indicar que los ficheros desarrollados en el contexto de este \gls{tfm} estarán disponibles en el repositorio\footnote{https://github.com/PaulaBartolomeMora/TFM} de GitHub dedicado a este proyecto.
